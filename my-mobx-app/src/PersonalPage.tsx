...
const PersonalPage: React.FC = observer(() => {
    ...
    const [forceRender, setForceRender] = useState(false); // Utilizare useState pentru a forța re-randarea
  ...
  return (
    <div className="container">
            ...
            <div className="mb-3">
                <p className="mb-1">Nume/Prenume: {personalData.name}</p>
                <p className="mb-1">Vârsta: {personalData.age} ani</p>
                <p className="mb-1">Grupa: {personalData.grupa}</p>
            </div>
